...
class Program41_5
{
    public static void main(String Ar[])
    {
        ...
        {
            mobj.Accept();
            int iRet[] = mobj.ArraySummation();
            System.out.println("Addition of elements of First Array : "+iRet[0]);
            System.out.println("Addition of elements of Second Array : "+iRet[1]);            
        }
    }
}