...
class MyArray
{
    ...
    public int[] ArrayCatRev()
    {
        int iCnt = 0, iIndex = 0;

        int Arr3[] = new int[Arr1.length + Arr2.length];

        for(iCnt = Arr2.length-1; iCnt >= 0; iCnt--)
        {
            Arr3[iIndex] = Arr2[iCnt];
            iIndex++;
        }
        for(iCnt = Arr1.length-1; iCnt >= 0; iCnt--)
        {
...
class Program42_3
{
    public static void main(String Ar[])
    {
        ...
        {
            mobj.Accept();
            int iRet[] = mobj.ArrayCatRev();
            System.out.println("Concatenated & reverese array : ");
